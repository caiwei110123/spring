...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	/** ClassLoader to resolve bean class names with, if necessary  如有必要，使用类加载器解析bean类名*/
	@Nullable
	...
	/** Whether to cache bean metadata or rather reobtain it for every access  无论是否缓存了数据，每次都从访问中重新获取*/
	...
	/** Spring ConversionService to use instead of PropertyEditors  转换服务*/
	@Nullable
	private ConversionService conversionService;

	/** Custom PropertyEditorRegistrars to apply to the beans of this factory   属性编辑器注册者*/
	private final Set<PropertyEditorRegistrar> propertyEditorRegistrars = new LinkedHashSet<>(4);

	/** Custom PropertyEditors to apply to the beans of this factory  自定义编辑器*/
